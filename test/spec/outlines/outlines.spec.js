...
describe('outlines', function() {
    ...
    beforeEach(module('eWaterCycleApp.outlines'));
    ...
    it('should create an application controller', inject(function($rootScope, $controller){
        ...
        $controller('OutlinesController', { $scope: scope });
        $httpBackend.flush();
    }));
    ...
    describe('directive', function() {
        ...
        it('should create an element with a button', function() {
            expect(html.html()).toContain('<button ng-click="ol.toggleOutlines()"');
        });

        it('should have a data binding to ol.outlines', function() {
            expect(html.html()).toContain('ng-class="{active: ol.outlines}"');
        });
